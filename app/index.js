...
var PhonegapSassGenerator = module.exports = function PhonegapSassGenerator(args, options, config) {
...
util.inherits(PhonegapSassGenerator, yeoman.generators.Base);

PhonegapSassGenerator.prototype.askFor = function askFor() {
  var cb = this.async();
...
PhonegapSassGenerator.prototype.gruntfile = function gruntfile() {
  this.template('Gruntfile.js');
};

PhonegapSassGenerator.prototype.packageJSON = function packageJSON() {
  this.template('_package.json', 'package.json');
};

PhonegapSassGenerator.prototype.git = function git() {
  this.copy('gitignore', '.gitignore');
  this.copy('gitattributes', '.gitattributes');
};

PhonegapSassGenerator.prototype.bower = function bower() {
  this.copy('bowerrc', '.bowerrc');
  this.copy('_bower.json', 'bower.json');
};

PhonegapSassGenerator.prototype.jshint = function jshint() {
  this.copy('jshintrc', '.jshintrc');
};

PhonegapSassGenerator.prototype.editorConfig = function editorConfig() {
  this.copy('editorconfig', '.editorconfig');
};

PhonegapSassGenerator.prototype.mainStylesheet = function mainStylesheet() {
  this.copy('main.scss', 'app/styles/main.scss');
};

PhonegapSassGenerator.prototype.writeIndex = function writeIndex() {
...
PhonegapSassGenerator.prototype.requirejs = function requirejs() {
  if (!this.includeRequireJS) {
    return;
  }
...
PhonegapSassGenerator.prototype.app = function app() {
...
PhonegapSassGenerator.prototype.phonegapSetup = function phonegapSetup() {
	var self = this;
